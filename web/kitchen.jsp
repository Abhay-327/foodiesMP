          ...
          <table align="center" class="table">
            ...
            <tr>
                    ...
                    <td bgcolor="black" width="120" height="40"><b><font color="yellow">TRANSACTION ID</font></b></td>
                     <td bgcolor="black" width="78" height="40"><b><font color="yellow">order List</font></b></td>
                 ...
                 <%
                   new connection();
                   try{
                   rs=connection.st.executeQuery("select * from kitchen");
                   while(rs.next())
                                         {
                %>
       <tr> <form action="check_1.jsp"><td bgcolor="ffb3d1" width="100"><b><font color="purple">
                    <%
                   out.print(rs.getString("name"));
                    %></font></td>
                    <td bgcolor="#1aff8c" width="280" ><font color="red">
                            <%out.print(rs.getString("transaction"));%></font></td>
                    <td bgcolor="yellow" width="280" ><font color="red">
                            <%out.print(rs.getString("list"));%></font></td>
                    
             
                    <%if(rs.getString("status").equals("pending")){%>
                    
     
          <td bgcolor="ffb3d1"><input type="submit" value="Deliver"></td>
                  
           <td><input type="hidden" value="<%out.print(rs.getString("transaction"));%>" name="trans">
          </td>
         <% }
            else{%>
               <td bgcolor="ffb3d1"><p>Delivered</p></td>
                       <%}%>
